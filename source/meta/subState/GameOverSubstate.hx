...
class GameOverSubstate extends MusicBeatSubState
{
	...
	public function new(character:String, x:Float, y:Float)
	{
		...
		if (PlayState.boyfriend.curCharacter != 'gf-stand')
		{
	...
	public static function preload()
	{
		...
		{
			case 'bf-og':
				PlayState.boyfriend.curCharacter = daBoyfriendType;
			case 'bf-pixel':
				PlayState.boyfriend.curCharacter = 'bf-pixel-dead';
				loopSoundName = 'MissingnoDeath';
				endSoundName = 'MissingnoDone';
				deathSoundName += '-pixel';
			case 'smol-hypno' | 'alexis':
				PlayState.boyfriend.curCharacter = 'smol-hypno';
			...
			case 'gf':
				PlayState.boyfriend.curCharacter = 'gf';
			case 'gf-stand' | 'gf-kneel':
				PlayState.boyfriend.curCharacter = 'gf-stand';
			...
			case 'ba-bf':
				PlayState.boyfriend.curCharacter = 'buryman-death';
				deathSoundName = 'buryman-death/BA${FlxG.random.int(0, 3)}';
				loopSoundName = 'BurymanDeath';
				precacheSoundFile('buryman-death/buriedThud');
				precacheSoundFile('buryman-death/buriedDeath');
			case 'dawn' | 'dawn-bf' | 'hellbellplayer':
				PlayState.boyfriend.curCharacter = 'dawn';
				loopSoundName = 'DeathTollDeathAmbience';
			case 'mike-bed' | 'mike-fp':
				PlayState.boyfriend.curCharacter = 'mike-death';
				deathSoundName = 'DissensionDeath';
			case 'mx' | 'lord-x' | 'hypno-cards':
				switch (PlayState.playerLane)
				{
					case 0:
						PlayState.boyfriend.curCharacter = 'mx';
					case 1:
						PlayState.boyfriend.curCharacter = 'lord-x';
					case 2:
						PlayState.boyfriend.curCharacter = 'hypno-cards';
				}
				deathSoundName = 'PS_Death';
			case 'grey':
				precacheSoundFile('Shitno-Death');
			default:
	...
	private static function precacheSoundFile(sound:String):Void
	{
		Paths.sound(sound);
	}
