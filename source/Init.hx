...
class Init extends FlxState
{
	...
	public static var gameSettings:Map<String, Dynamic> = [
		...
		'Auto Pause' => [Checkmark, true, '',],
		'FPS Counter' => [Checkmark, true, 'Whether to display the FPS counter.',],
		'Memory Counter' => [
			Checkmark,
			true,
			'Whether to display approximately how much memory is being used.',
		],
		'Debug Info' => [Checkmark, false, 'Whether to display information like your game state.',],
		'Reduced Movements' => [
			Checkmark,
			false,
			'Whether to reduce movements, like icons bouncing or beat zooms in gameplay.',
		...
		'Display Accuracy' => [Checkmark, true, 'Whether to display your accuracy on screen.'],
		'Disable Antialiasing' => [
			Checkmark,
			false,
			'Whether to disable Anti-aliasing. Helps improve performance in FPS.',
		...
		'Use Forever Chart Editor' => [Checkmark, false, 'When enabled, uses the custom Forever Engine chart editor!',],
		'Disable Note Splashes' => [
			Checkmark,
			false,
			'Whether to disable note splashes in gameplay. Useful if you find them distracting.',
		],
		'Offset' => [NumberSelector, 0, 'How much to offset the song by in gameplay.', 1, -1000, 1000],
		'Filter' => [
			StringSelector,
			'none',
			'Choose a filter for colorblindness.',
		...
		"UI Skin" => [StringSelector, 'default', 'Choose a UI Skin for judgements, combo, etc.', []],
		"Note Skin" => [StringSelector, 'default', 'Choose a note skin.', []],
		"Framerate Cap" => [NumberSelector, 120, 'Define your maximum FPS.', 30, 30, 360],
		"Opaque Arrows" => [Checkmark, false, "Makes the arrows at the top of the screen opaque again.",],
		"Opaque Holds" => [Checkmark, false, "Huh, why isnt the tail cut off?"],
		'Ghost Tapping' => [
			Checkmark,
			true,
			"Enables Ghost Tapping, allowing you to press inputs without missing.",
		],
		'Centered Notefield' => [Checkmark, false, "Center the notes, disables the enemy's notes."],
		"Custom Titlescreen" => [
			Checkmark,
			false,
			"Enables the custom Forever Engine titlescreen! (only effective with a restart)",
		...
		'Psyshock' => [Checkmark, true, "Whether Hypno can Psyshock you on songs with the Pendulum",],
		...
		'Gaussian Enabled' => [Checkmark, false, "Whether to enable the Gaussian shader on the Hell stage"],
		/*'Missingno Shaders' => [Checkmark, true, "Whether to enable the Missingno shaders."],*/
		'Freezing Enabled' => [
			Checkmark,
			true,
		...
		'Typhlosion Warmth Percent' => [NumberSelector, 100, "How much warmth your Typhlosion gives you", 0.5, 5, 200],
		'Freezing Rate Percent' => [NumberSelector, 100, "How fast you freeze", 0.5, 0, 200],
		'Fifth Key' => [Checkmark, true, "Whether to enable the bell notes on Death Toll"],
		"Hell Mode Ear Ringing" => [
			Checkmark,
			true,
			"Whether an ear ringing sound should play when missing a bell in Hell Mode Death Toll"
		],
		'Forced Accuracy' => [Checkmark, true, "Whether Insomnia should have its forced accuracy gimmick"],
		"Accuracy Cap" => [
			NumberSelector,
			90,
		...
		'Touch Mode' => [Checkmark, true, "Enable to use Touch Screen."],
